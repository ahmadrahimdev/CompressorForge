// src/lib.rs
/*
 * Core library for CompressorForge
 */
...
#[derive(Debug)]
pub struct CompressorForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CompressorForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CompressorForge processing");
    
    let mut processor = CompressorForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CompressorForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CompressorForgeProcessor::new(false);
